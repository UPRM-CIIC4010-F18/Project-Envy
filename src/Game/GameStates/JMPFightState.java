...
public class JMPFightState extends InWorldState{
    ...
    public JMPFightState(Handler handler ,BaseHostileEntity enemy, String prevState) {
        super(handler);
        ...
        this.enemy = new JMPEnemy("???", Images.SEnemy);
        ...
        //enemyFSkill = new Animation(50,Images.SSkill); // @Sergio: "Replace this with Images.FireSkill so u can do ur stuff"
    ...
    private void drawEntities(Graphics2D g2) {
        ...
        g2.drawImage(enemy.getEnemyFrames(), enemyRect.x, enemyRect.y, enemyRect.width, enemyRect.height, null);
    }
...
//        	choose options to the left
    ...
    private void callSkill(Graphics g) {
        ...
        g.drawImage(Images.tint(enemy.getEnemyFrames(),0,0,Math.max(0, blue--)),enemyRect.x,enemyRect.y,enemyRect.width,enemyRect.height,null);
    ...
    private void EcallSkill(Graphics g) {
        ...
        g.drawImage((enemySkill.getCurrentFrame()),(handler.getWidth()/ 5)-93,entityY-105,256,256,null);
